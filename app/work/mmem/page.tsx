...
export const metadata: Metadata = {
  title: "MMEM — Nick Toh",
  description: "UX case study exploring brand identity and collateral.",
};

export default function MMEM() {
  return (
    <CaseStudyLayout
      ...
      heroImage={{ src: "/images/mmem/hero.jpg", alt: "MMEM" }}
    ...
    >
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          <p>Placeholder — a UX case study exploring brand identity and collateral.</p>
          <p>We adopted the Double Diamond process throughout the journey of this exercise.</p>
          <div className="caseImgRow single">
            <CaseImage src="/images/mmem/overview-1.jpg" alt="Overview" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          ...
          <div className="caseImgRow">
            <CaseImage src="/images/mmem/discover-1.jpg" alt="Research" />
            <CaseImage src="/images/mmem/discover-2.jpg" alt="Research" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          ...
          <div className="caseImgRow">
            <CaseImage src="/images/mmem/define-1.jpg" alt="Persona" />
            <CaseImage src="/images/mmem/define-2.jpg" alt="Persona" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          ...
          <div className="caseImgRow triple">
            <CaseImage src="/images/mmem/develop-1.jpg" alt="Ideation" />
            <CaseImage src="/images/mmem/develop-2.jpg" alt="Ideation" />
            <CaseImage src="/images/mmem/develop-3.jpg" alt="Ideation" />
          </div>
          <h3>User Flow</h3>
          <p>Placeholder — user flow description goes here.</p>
          <div className="caseImgRow single">
            <CaseImage src="/images/mmem/develop-4.jpg" alt="User flow" />
          </div>
          <h3>Lo-fi Wireframe</h3>
          <div className="caseImgRow single">
            <CaseImage src="/images/mmem/develop-5.jpg" alt="Wireframe" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          ...
          <div className="caseImgRow triple">
            <CaseImage src="/images/mmem/deliver-1.jpg" alt="Hi-fi design" />
            <CaseImage src="/images/mmem/deliver-2.jpg" alt="Hi-fi design" />
            <CaseImage src="/images/mmem/deliver-3.jpg" alt="Hi-fi design" />
          </div>
        </div>
      </Reveal>
      ...
      <Reveal className="caseSection reveal">
        ...
        <div className="caseBody">
          ...
          <div className="caseImgRow single">
            <CaseImage src="/images/mmem/testing-1.jpg" alt="Usability testing" />
          </div>
        </div>
      </Reveal>
