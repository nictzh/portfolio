        ...
        <div className="caseBody">
          ...
          <div className="caseDeliverBento">
            <div className="caseDeliverRow caseDeliverRow--top">
              <div><CaseImage src="/images/aspect-skincare/deliver-1.png" alt="Hi-fi design" /></div>
              <div><CaseImage src="/images/aspect-skincare/deliver-2.png" alt="Hi-fi design" /></div>
              <div><CaseImage src="/images/aspect-skincare/deliver-3.png" alt="Hi-fi design" /></div>
            </div>
            <div className="caseDeliverRow caseDeliverRow--bottom">
              <div><CaseImage src="/images/aspect-skincare/deliver-4.png" alt="Hi-fi design" /></div>
              <div><CaseImage src="/images/aspect-skincare/deliver-5.png" alt="Hi-fi design" /></div>
            </div>
          </div>
          <h3>Handover</h3>
